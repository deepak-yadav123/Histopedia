        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="oleezMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    <li class="nav-item ">
                        <a class="nav-link active" href="blog-standard.php?_id=<?php echo $_id ?>">Home</a>
                    </li>
                    <li class="nav-item ">
            ...
            <div class="row">
                <div class="col-md-8">
                    <article class="blog-post wow fadeInUp">
                        ...
                        <p class="post-excerpt"><?php echo _getSingleheritage($_id, '_heritageolocationfeature') ?></p>

                    </article>
                    <article class="blog-post wow fadeInUp">
                        <h4 class="post-title"> <?php echo _getSingleheritage($_id, '_heritagename'); ?> History </h4>
                        <p class="post-excerpt"><?php echo _getSingleheritage($_id, '_heritagehistory'); ?> </p>
