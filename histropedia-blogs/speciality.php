            ...
            <div class="row">
                <div class="col-md-8">
                    <article class="blog-post wow fadeInUp">
                        ...
                        <h4 class="post-title">Speciality of <?php echo _getSingleheritage($_id, '_heritagename'); ?></h4>
                        <p class="post-excerpt"><?php echo _getSingleheritage($_id, '_heritagespeciality') ?></p>
