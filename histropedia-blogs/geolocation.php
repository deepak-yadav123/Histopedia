    ...
    <header class="oleez-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active" href="Geolocation.php?_id=<?php echo $_id?>">Geolocation</a>
                    </li>
                    <li class="nav-item ">
            ...
            <div class="row">
                <div class="col-md-8">
                    <article class="blog-post wow fadeInUp">
                        ...
                        <h4 class="post-title">Geolocation</h4>

                        <iframe src="https://www.google.com/maps?q=19.8762,75.3433&hl=es;z=14&output=embed" frameborder="0" width="700px" height="500px" >
